...
<head>
    ...
    <script type="text/javascript" src="<%=basePath %>resources/lib/jquery-2.1.3.js"></script>
    <script type="text/javascript" src="<%=basePath %>resources/lib/canvas-toBlob.js"></script>
    <script type="text/javascript" src="<%=basePath %>resources/lib/FileSaver.js"></script>
    <script src="<%=basePath %>resources/lib/main-debug-symbol.js"></script>
    <link href="<%=basePath %>resources/lib/style.css" rel="stylesheet" type="text/css">
...
<div class="main">
    ...
    <div id="PaletteAndDiagram">
        <div id="sideBar">
            ...
            <div id="myPalette" class="my-palette">
                <canvas width="230" height="625" tabindex="0"
    ...
    <div id="openDocument" class="draggable" style="visibility: hidden;">
        ...
        <button id="cancelBtn" class="elementBtn" type="button" onclick="closeElement(&#39;openDocument&#39;)">
            Cancel
        </button>
    </div>
    ...
    <div id="editPanel" class="edit-panel">
        ...
        <input name="annotationContent" type="text"/>
  ...
  "nodeDataArray": [ 
{"category":"activity", "item":"generic task", "key":5, "loc":"860 820", "annotationContent":"C", "taskType":0, "boundaryEventArray":[  ],"properties":{
"propertyA1":{"type":"annotationContent","content":"text1","writeable":"true"},
"propertyA2":{"type":"annotationContent","content":"text2","writeable":"true"},
"propertyA2":{"type":"annotationContent","content":"text3","writeable":"true"},
"propertyA3":{"type":"annotationContent","content":"text4","writeable":"true"}
}},
{"category":"activity", "item":"generic task", "key":-4, "loc":"860 660", "annotationContent":"B2", "taskType":0, "boundaryEventArray":[  ]},
{"category":"activity", "item":"generic task", "key":-5, "loc":"710 570", "annotationContent":"A", "taskType":0, "boundaryEventArray":[  ]},
{"category":"activity", "item":"generic task", "key":-6, "loc":"560 730", "annotationContent":"B1", "taskType":0, "boundaryEventArray":[  ]},
{"category":"event", "item":"start", "key":101, "loc":"706.421875 275", "annotationContent":"Start", "eventType":1, "eventDimension":1},
{"category":"event", "item":"End", "key":104, "loc":"559.421875 860", "annotationContent":"End", "eventType":1, "eventDimension":8},
{"category":"subprocess", "key":801, "loc":"372.541163125423 409.743211874577", "annotationContent":"Subprocess", "isGroup":true, "taskType":0, "isSubProcess":true, "boundaryEventArray":[  ]},
{"category":"event", "item":"start", "key":-8, "loc":"480.421875 285", "annotationContent":"Start", "eventType":1, "eventDimension":1, "group":801},
{"category":"event", "item":"End", "key":-9, "loc":"508.421875 449.9999999999999", "annotationContent":"End", "eventType":1, "eventDimension":8, "group":801},
{"category":"subprocess", "key":-10, "loc":"358.359375 437.4749999999999", "annotationContent":"Subprocess", "isGroup":true, "taskType":0, "isSubProcess":true, "boundaryEventArray":[  ], "group":801},
{"category":"event", "item":"start", "key":-11, "loc":"248.421875 343.9999999999999", "annotationContent":"Start", "eventType":1, "eventDimension":1, "group":-10},
{"category":"event", "item":"End", "key":-12, "loc":"279.421875 510.9999999999999", "annotationContent":"End", "eventType":1, "eventDimension":8, "group":-10},
{"category":"gateway", "key":201, "loc":"413.421875 357", "annotationContent":"Gateway", "gatewayType":0, "group":801}
 ],
  "linkDataArray": [ 
